...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { click: @stat.click, edit: @stat.edit, view: @stat.view } }, as: :json
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { click: @stat.click, edit: @stat.edit, view: @stat.view } }, as: :json
    assert_response 200
  end
